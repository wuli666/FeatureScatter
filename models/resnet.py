...
__all__ = ['ResNetCifar', 'resnet18_cifar', 'resnet34_cifar', 'resnet50_cifar']
...
class ResNetCifar(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            in_channels, self.inplanes, kernel_size=(3, 3), stride=(1, 1), padding=1, bias=False)
...
def resnet18_cifar(**kwargs: Any) -> ResNetCifar:
    return _resnet(BasicBlock, [2, 2, 2, 2], **kwargs)


def resnet34_cifar(**kwargs: Any) -> ResNetCifar:
    return _resnet(BasicBlock, [3, 4, 6, 3], **kwargs)


def resnet50_cifar(**kwargs: Any) -> ResNetCifar:
